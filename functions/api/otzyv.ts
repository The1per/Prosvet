...
/** Сколько отзывов в сутки с одного браузера. Не один: человек вправе
    дописать, вспомнив ещё одну беду, -- но и не без счёта. Три поставлено
    решением хозяина 13 сентября 2026 (было пять). Число меняется здесь и в
    строке T.fbMany -- в двух местах, и оба должны говорить одно и то же. */
const В_СУТКИ = 3;
