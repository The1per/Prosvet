            ...
            >
              ...
              <div className={телефон ? "w-full" : "shrink-0"}>
                ...
                {/* СЛОВА НЕДЕЛИ -- ОТДЕЛЬНОЙ ПОЛОСОЙ ВО ВСЮ ШИРИНУ. Прежде они
                    ...
                    была одна. Строк стало три -- пресса, паблики и люди, по три слова в
...
function СловаНедели({ w, lang, phone = false }: { w: Week; lang: Lang; phone?: boolean }) {
  ...
  const текст = ru
    ? "Слова, которых на этой неделе стало заметно больше обычного. "
      + "«Пресса» — заголовки Интерфакса и МК; «паблики» — посты городских "
      + "каналов; «люди» — комментарии под ними и в городских пабликах. "
    ...
    : "Words that got far more common this week. “Press” are Interfax and MK "
      + "headlines; “channels” are city channels’ own posts; “people” are the "
      + "comments under them. They often differ.";
  return (
