        ...
        >
          ...
          >
            ...
            {!телефон && (
              ...
              /* КНОПКА ПОДТЯНУТА ВВЕРХ И ВЛЕВО. Между числом с датой и парой
                 ФОМа стоял воздух, которого в верхнем углу карточки не лишку, а
                 сама кнопка была отбита от левого края сильнее, чем число над
                 ней, и колонка читалась ступенькой. */
              <div className="-mt-3 flex items-center gap-5">
                <div className="-ml-2 shrink-0">{парФОМ}</div>
                {/* ВЫСОТА ОТВЕДЕНА ПОД ТРИ СТРОКИ. Было под две (68 пикселей),
                    и при двух рядах этого хватало. С появлением третьего --
                    прессы -- строка стала длиннее в полтора раза: на свежей
                    неделе она уже переносится на вторую строку и занимает 63,
                    а на самых длинных займёт третью. Без запаса на такой неделе
                    подпрыгивал бы весь график под блоком. Цена -- тридцать
                    лишних пикселей на большинстве недель, и она меньше, чем
                    цена дёргающейся страницы. */}
                <div className="min-w-0 flex-1" style={{ minHeight: 96 }}>
