...
export default function App() {
  ...
  const [настройки, setНастройки] = useLocal("pai.vid.v3", {
    простой: true, индекс: true, превышение: false, сдержанно: false,
  });
...
function НастройкиВида({
  ...
  значения: { простой: boolean; индекс: boolean; фом: boolean; превышение: boolean;
              сдержанно: boolean };
  менять: (ключ: "простой" | "индекс" | "фом" | "превышение" | "сдержанно",
           v: boolean) => void;
  lang: Lang;
  phone?: boolean;
}) {
  ...
  const ряды: { к: "простой" | "индекс" | "фом" | "превышение" | "сдержанно";
