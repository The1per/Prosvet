...
function СловаНедели({ w, lang, phone = false }: { w: Week; lang: Lang; phone?: boolean }) {
  ...
  const текст = ru
    ? "Слова, которых на этой неделе стало заметно больше обычного. "
      ...
      + "самих городских каналов; «пресса» — заголовки Интерфакса и МК. "
      + "Часто они говорят о разном: пресса называет событие, люди — то, что "
      + "от него чувствуют. Паблики собраны с 2021 года, раньше их строки нет."
    : "Words that got far more common this week. “People” are comments in city "
      + "groups; “channels” are those channels’ own posts; “press” are Interfax "
      + "and MK headlines. They often differ.";
  return (
