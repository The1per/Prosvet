  ...
  return (
    <div className="relative flex w-full flex-1 select-none" draggable={false} onDragStart={(e) => e.preventDefault()}>
      ...
      >
        ...
        {liveX != null && (
          <g>
            {/* Затенения здесь больше нет: серое поле на четверть графика
                читалось как «эта часть хуже», хотя означает ровно обратное --
                это недели, на которых индекс себя и доказывает. Осталась черта
                и подпись к ней. */}
