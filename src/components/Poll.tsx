...
/**
 * ВРЕМЕННО: опрос сбрасывается при каждой загрузке страницы, чтобы форму было
 * видно, а не только её результат. Ответы по-прежнему сохраняются -- просто не
 * читаются обратно. Перед публикацией снять.
 */
const СБРАСЫВАТЬ_ПРИ_ЗАГРУЗКЕ = true;
