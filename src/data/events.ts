...
export const EVENTS: Ev[] = [
  ...
  },
  {
    ...
    // «COVID, локдаун», а не просто «Локдаун» (решение хозяина, 12 сентября
    // 2026): рядом на ленте стоит «COVID, 2 волна», и без имени болезни первая
    // метка читалась как событие другого рода.
    shortRu: "COVID, локдаун",
    shortEn: "COVID, lockdown",
    whyRu:
