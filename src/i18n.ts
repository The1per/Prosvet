    ...
    ru: [
      {
        ...
        d: "Это модель, обученная на открытых данных. Опросы легко исказить: люди умеют молчать убедительнее, чем говорить. Поведение скрыть сложнее — цифровой след остаётся почти всегда. Отпечаток этот частичный, но по нему можно судить о том, что люди чувствуют.",
      },
      {
    ...
    en: [
      {
        ...
        d: "This is a model trained on open data. Surveys are easy to distort: people are better at staying silent than at speaking. Behaviour is harder to hide — a digital trace remains almost always. That imprint is partial, but it still tells you something about what people feel.",
      },
      {
