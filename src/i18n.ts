...
export const T = {
  ...
  limitList: {
    ru: [
      ...
      "По регионам он не считает и считать не будет: региональных опросов, с которыми можно было бы сверяться, нет — а без ориентира проверять нечем.",
    ...
    en: [
      ...
      "It does not measure regions and will not: there are no regional polls to check against, and without a reference point there is nothing to check with.",
